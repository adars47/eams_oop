    ...
    <style>
        ...
        * {
        ...
        .tab {
            overflow: hidden;
            border: 1px solid #ccc;
            background-color: rgba(232, 207, 207, 0.07);
            height: 12%;
            margin: 2px 16px;
        }
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                if(empty($_SESSION['user'])){
                    echo '<li><a href="/login"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>';
                     echo '<li><a href="/register"><span class="glyphicon glyphicon-log-in"></span> Register</a></li>';
                }
                else{
...
if(isset($_SESSION['success'])){
    foreach($_SESSION['success'] as $key=>$success) {
        echo('<div class="alert alert-success alert-dismissible fade in" id="alert"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>'.$success["message"].'</div>');
        ...
        if(isset($_SESSION['error'])) {
            ...
            {
                echo('<div class="alert alert-danger alert-dismissible fade in" id="alert"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>'.$err["message"].' </div>');
